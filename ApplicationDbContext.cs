...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminTable>(entity =>
        {
            ...
            entity.HasOne(d => d.Org).WithMany(p => p.AdminTables)
                .HasForeignKey(d => d.OrgId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AdminTable_OrgTable");

            entity.HasOne(d => d.Student).WithMany(p => p.AdminTables)
        ...
        modelBuilder.Entity<CollegeTable>(entity =>
        {
            ...
            entity.HasOne(d => d.Org).WithMany(p => p.CollegeTables)
                .HasForeignKey(d => d.OrgId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CollegeTable_OrgTable");
        });
        ...
        modelBuilder.Entity<EventTable>(entity =>
        {
            ...
            entity.HasOne(d => d.College).WithMany(p => p.EventTables)
        ...
        modelBuilder.Entity<FollowedOrgsTable>(entity =>
        {
            ...
            entity.HasOne(d => d.Org).WithMany(p => p.FollowedOrgsTables)
                .HasForeignKey(d => d.OrgId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FollowedOrgsTable_OrgTable");

            entity.HasOne(d => d.Student).WithMany(p => p.FollowedOrgsTables)
                .HasForeignKey(d => d.StudentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<OrgHighlightsTable>(entity =>
        {
            ...
            entity.HasOne(d => d.Org).WithMany(p => p.OrgHighlightsTables)
                .HasForeignKey(d => d.OrgId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ReportTable>(entity =>
{
            ...
            entity.HasOne(d => d.Event).WithMany(p => p.ReportTables)
                .HasForeignKey(d => d.EventId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ReportTable_EventTable");

            entity.HasOne(d => d.Org).WithMany(p => p.ReportTables)
                .HasForeignKey(d => d.OrgId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<StudentTable>(entity =>
    {
            ...
            entity.HasOne(d => d.College).WithMany(p => p.StudentTables)
                .HasForeignKey(d => d.CollegeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
